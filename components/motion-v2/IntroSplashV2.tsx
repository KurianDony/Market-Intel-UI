...
type IntroSplashV2Props = {
  /** Fires after the overlay has faded out and unmounted. */
  onComplete?: () => void;
};

export function IntroSplashV2({ onComplete }: IntroSplashV2Props) {
  ...
  return (
    ...
    >
      <EncryptedText
        ...
        className="inline-block whitespace-nowrap text-center font-mono text-[36px] font-bold uppercase tracking-[3px] text-[#ffffff] opacity-95 [text-shadow:none]"
      />
    </div>
  );
}
